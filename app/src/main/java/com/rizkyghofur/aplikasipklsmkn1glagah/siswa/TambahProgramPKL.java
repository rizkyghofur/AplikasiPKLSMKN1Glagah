...
public class TambahProgramPKL extends AppCompatActivity {
        ...
        btn_simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tanggalx.isEmpty()) {
                    ...
                    simpanData(tanggalx, kompetensi_dasarx, topik_pekerjaanx, dudi_pasanganx);
                }
            }
        });
    }
    ...
    private void simpanData(String tanggal, String kompetensi_dasar, String topik_pekerjaan, String dudi_pasangan) {
        String url = Server.URL + "tambah_program_pkl_siswa.php?id_siswa=" + user + "&tanggal=" + tanggal + "&kompetensi_dasar=" + kompetensi_dasar + "&topik_pekerjaan=" + topik_pekerjaan + "&dudi_pasangan=" + dudi_pasangan;

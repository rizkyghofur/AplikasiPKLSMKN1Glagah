...
public class AdapterPermohonanPKL extends BaseAdapter {
    private Activity activity;
    private LayoutInflater inflater;
    private List<DataPermohonanPKL> items;

    public AdapterPermohonanPKL(Activity activity, List<DataPermohonanPKL> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.activity_siswa_permohonan_pkl_list, null);

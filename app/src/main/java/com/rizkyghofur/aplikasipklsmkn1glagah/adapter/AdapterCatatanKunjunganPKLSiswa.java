...
public class AdapterCatatanKunjunganPKLSiswa extends BaseAdapter {
    private Activity activity;
    private LayoutInflater inflater;
    private List<DataCatatanKunjunganPKL> items;

    public AdapterCatatanKunjunganPKLSiswa(Activity activity, List<DataCatatanKunjunganPKL> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.activity_siswa_catatan_kunjungan_pkl_list, null);
